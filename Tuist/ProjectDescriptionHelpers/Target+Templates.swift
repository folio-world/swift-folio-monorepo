...
//    private static func make(project: ModulePath.Project, factory: TargetFactory) -> Self {
//        return .init(
//            name: factory.name,
//            platform: factory.platform,
//            product: factory.product,
//            productName: factory.productName,
//            bundleId: factory.bundleId ?? Project.Environment.bundlePrefix(project: project) + ".\(factory.name)",
//            deploymentTarget: factory.deploymentTarget ?? Project.Environment.deploymentTarget(project: project, app: .IOS),
...
//
//public extension Target {
//    static func app(project: ModulePath.Project, module: ModulePath.App, factory: TargetFactory) -> Self {
//        var newFactory = factory
//        
//        newFactory.name = Project.Environment.name(project: project, app: module)
//        newFactory.productName = Project.Environment.name(project: project, app: module)
//        newFactory.bundleId = Project.Environment.bundleId(project: project, app: module)
//        newFactory.product = Project.Environment.product(project: project, app: module)
//        switch module {
//        case .IOS:
